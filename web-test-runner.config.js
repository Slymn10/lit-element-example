...
export default {
  rootDir: '.',
  files: ['./test/**/*_test.js', './test/**/*.test.js'],
  nodeResolve: {exportConditions: mode === 'dev' ? ['development'] : []},
  preserveSymlinks: true,
  browsers: commandLineBrowsers ?? [browsers.chromium], // Use only Chromium for now
  testFramework: {
  ...
  // Define process global to fix Redux issues
